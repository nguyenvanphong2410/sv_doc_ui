                    ...
                    <Card
                      ...
                      actions={[
                        <Tooltip key={1} title={`Tài liệu này có 12 lượt xem`} color="purple">
                          <Link>
                            <EyeOutlined style={{fontSize: '18px'}} key="view" />
                            <span style={{fontSize: '18px', marginLeft: '2px'}}>
                        ...
                        <Tooltip key={4} title="Tải xuống tài liệu" color="green">
                          <a href={item?.file_record} download target="blank">
                        ...
                        title={
                          <div>
                            ...
                            <div className={styles.itemCard}>
                              ...
                              <span className={styles.textOriginCard}> Mã: </span>
                              <span className={styles.infoOriginCard}>{item?.code}</span>
                            </div>
                            <div className={styles.itemCard}>
                            ...
                            <div className={styles.itemCard}>
                              <span>
                                ...
                                <span className={styles.textOriginCard}> Thời gian xuất bản: </span>
                                <span className={styles.infoOriginCard}>
                                  {dayjsFormatSort(item?.publication_time)}
                                </span>
                              </span>
                            </div>
                            <div className={styles.itemCard}>
